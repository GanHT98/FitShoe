...
import 'package:fit_shoe/registerscreen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  String urlLogin = "https://minemp98.com/fitshoe/php/login_user.php";
                ...
                children: <Widget>[
                  ...
                  TextField(
                      ...
                      decoration: InputDecoration(
                        labelStyle: TextStyle(color:Colors.red[500]),
                        labelText: 'Email',
                        hintText: 'Enter Your Email',
                        icon: Icon(Icons.email, color: Colors.red[500]),
                      )),
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      icon: Icon(Icons.lock, color: Colors.red[500]),
                    ),
                    obscureText: true,
                  ),
                  SizedBox(
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      Text('Remember Me ',
                          style: TextStyle(
                              fontSize: 18, fontWeight: FontWeight.bold,color: Colors.blue[400])),
                      MaterialButton(
